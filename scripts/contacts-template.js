    ...
    return `
        <div class="contact-card">
            ...
            <div class="contact-area">
                <div class="contact-avatar"><span class="avatar-placeholder">${initials}</span></div>
 ...
 */
/**
 * Returns the hero/left section of the add-contact dialog.
 * @returns {string} Result.
 */
...
/**
 * Returns the form HTML for the add-contact dialog.
 * @returns {string} Result.
 */
...
/**
 * Returns the mobile more-menu HTML for the contact details view.
...
/**
 * Returns the header and actions section of the contact details view.
 * @param {string} id - Contact ID.
 * @param {string} name - Contact name.
 * @param {string} email - Contact email.
 * @param {string} phone - Contact phone.
...
function getContactDetailsTemplate(initials, name, email, phone, id) {
    const phoneSection = phone ? `<div class="contact-info-phone"><p><strong>Phone</strong></p><p>${phone}</p></div>` : '';
    return `
 ...
 */
/**
 * Returns the form fields section for the edit-contact dialog.
 * @param {string} id - Contact ID.
 * @param {string} name - Contact name.
 * @param {string} email - Contact email.
 * @param {string} phone - Contact phone.
