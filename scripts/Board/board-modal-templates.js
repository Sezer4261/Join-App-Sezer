/** @file HTML templates for task detail modal. */
...
function getModalPriorityIconSrc(priority) {
  ...
  if (priority === "medium") return "./assets/icons/medium-orange.svg";
  return "./assets/img/category-low.svg";
}
...
function getModalHeaderHTML(task) {
  ...
  const prioSrc = getModalPriorityIconSrc(task.priority);
  return /*html*/ `
