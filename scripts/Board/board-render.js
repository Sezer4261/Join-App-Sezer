...
/**
 * Resolves visible tasks and collapse state for a board column.
 * @param {Array} columnTasks - Tasks in the column.
 * @param {number} compactVisibleLimit - Max visible tasks in compact mode.
 * @param {string} columnId - Column element id.
 * @returns {{ visibleTasks: Array, shouldCollapse: boolean, expanded: boolean }}
 */
...
/**
 * Appends task cards and optional summary card to a column wrapper.
 * @param {HTMLElement} wrapper - Column task wrapper element.
 * @param {Array} visibleTasks - Tasks to render.
 * @param {boolean} shouldCollapse - Whether the column is collapsed.
